...
public class TwitterBotTest {
    ...
    public void simpleTwitterBotShortTest() {
        List<String> desiredTweet = new ArrayList<>(
                Arrays.asList("hello", "cis1200", "world", "!")
        );
    ...
    @Test
    public void testPunctuationWithIsPunctuated() {
        String words = "0, Testing punctuation.\n" + "1, Does it work?";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot t = new TwitterBot(br, 1);

        String actual = t.generateTweet(5);
        assertTrue(TwitterBot.isPunctuated(actual));
    }

    @Test
    public void testOneWord() {
        String words = "0, CIS1200";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot t = new TwitterBot(br, 1);

        String expected = "cis1200";
        String actual = t.generateTweet(1);
        actual = actual.substring(0, expected.length());
        assertEquals(expected, actual);
    }

    @Test
    public void testLongerSecondTweet() {
        String words = "0, CIS1200\n" + "1, I enjoy this class!";
        StringReader sr = new StringReader(words);
        BufferedReader br = new BufferedReader(sr);
        TwitterBot t = new TwitterBot(br, 1);

        int requestedLength = 10;
        String actual = t.generateTweet(requestedLength);
        assertTrue(actual.split(" ").length <= requestedLength);
    }
