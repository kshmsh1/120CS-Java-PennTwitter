...
public class TweetParserTest {
    ...
    @Test
    public void testExtractColumnInvalidColumn() {
        assertNull(TweetParser.extractColumn("", 1));
        // assertEquals("Invalid column index.", e1.getMessage());

        assertNull(TweetParser.extractColumn("", -1));
        /*
         * assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
         * TweetParser.extractColumn("This is a tweet.", -1);
         * });
         *
         */
        // assertEquals("Invalid column index.", e1.getMessage());
    ...
    @Test
    public void testExtractColumnWhitespace() {
    ...
    @Test
    public void testCsvDataToTweetsInvalidColumn() {
        StringReader sr = new StringReader(
                "0, The end should come here.\n"
                        + "1, This comes from data with no duplicate words!"
        );
    ...
    @Test
    public void testCsvDataToTweetsWhitespace() {
        StringReader sr = new StringReader(" ");
        BufferedReader br = new BufferedReader(sr);
    ...
    public void testParseAndCleanTweetRemovesURLS2() {
        List<List<String>> sentences = TweetParser
                .parseAndCleanTweet("http://www.cis.upenn.edu abc http://www.wharton.upenn.edu/");
        List<List<String>> expected = new LinkedList<List<String>>();
        expected.add(singleton("abc"));
        assertEquals(expected, sentences);
    }
    ...
    @Test
    public void testCsvDataToTrainingDataInvalidColumn() {
        StringReader sr = new StringReader(
                "0, The end should come here.\n"
                        + "1, This comes from data with no duplicate words!"
        );
